...
class NewsListAPIView(ListAPIView, GenericViewSet):
    """Barcha yangiliklar"""
    queryset = models.Elon.objects.select_related('created_by', "updated_by").order_by("-id")
...
class HeaderNewsListAPIView(ListAPIView, GenericViewSet):
    ...
    queryset = models.Elon.objects.select_related('created_by', "updated_by").order_by("-id")[:5]
    serializer_class = NewsListSerializer


class TheMostReadNewsListAPIView(ListAPIView, GenericViewSet):
    """Eng ko'p o'qilgan yangiliklar"""
    queryset = models.Elon.objects.select_related('created_by', "updated_by").order_by("-post_viewed_count")[:8]
    serializer_class = NewsListSerializer
